...
class _InvoiceWidgetState extends State<InvoiceWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: 'Alamat Seperti Biasa');
    _model.textController2 ??= TextEditingController(text: 'Lulu');
    _model.textController3 ??= TextEditingController(text: '0895422720524');
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: 'Masukan Nomor Penerima',
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: UnderlineInputBorder(
                                  borderSide: BorderSide(
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 4.0, 0.0, 12.0),
                            child: Text(
                              'Di bawah ini adalah daftar cucian yang ada di keranjang Anda.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
